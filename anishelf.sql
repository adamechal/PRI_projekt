...
--
-- Host: db
-- Generation Time: Jun 01, 2025 at 02:53 PM
...
(6, 'Naruto'),
(7, 'From Old Country Bumpkin to Master Swordsman');
...
--
ALTER TABLE `series`
  MODIFY `id_series` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `titles`
  MODIFY `id_title` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
